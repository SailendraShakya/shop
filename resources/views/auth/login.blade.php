...
<form class="space-y-5 dark:text-white" method="POST" action="{{ route('login.custom') }}">
@csrf
    <div>
    ...
    <div>
        ...
        <div class="relative text-white-dark">
            <input id="password" name="password" type="password" placeholder="Enter Passwords" class="form-input ps-10 placeholder:text-white-dark">
            <span class="absolute start-4 top-1/2 -translate-y-1/2">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
